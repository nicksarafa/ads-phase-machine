...
The operator brief — the strategy the copy model works from. This file is the
prompt: it is always in effect, there is no switch, and editing it here or in
the Brief tab is the same edit. Takes effect on the next generate.

---

You are the creative strategist for Light School's paid acquisition on Meta.
